...
<h1><span class="title_manage"><fmt:message key="administer_studies" bundle="${resword}"/>
<!-- <a href="javascript:openDocWindow('https://docs.openclinica.com/3.1/administer-study')">
