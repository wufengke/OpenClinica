...
<!-- <a href="javascript:openDocWindow('https://docs.openclinica.com/3.1/study-setup')">
...
<div style="float:right;padding-right:6px;width:8%;clear:both">
   ...
   <img name="bt_Print1" src="images/bt_Print.gif" border="0" alt="<fmt:message key="print_all_available_crf" bundle="${resword}"/>" title="<fmt:message key="print_all_available_crf" bundle="${resword}"/>" align="left" hspace="6"></a>
   </div>
