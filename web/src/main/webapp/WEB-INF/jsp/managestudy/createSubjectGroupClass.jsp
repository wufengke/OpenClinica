...
<h1><span class="title_manage"><fmt:message key="create_a_subject_group_class" bundle="${resword}"/>
<!-- <a href="javascript:openDocWindow('https://docs.openclinica.com/3.1/study-setup/build-study#content-title-4375')">
