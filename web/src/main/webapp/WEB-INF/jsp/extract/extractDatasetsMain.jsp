...
<h1><span class="title_manage"><c:out value="${study.name}" />: <fmt:message key="extract_datasets" bundle="${resworkflow}"/>
<!-- <a href="javascript:openDocWindow('https://docs.openclinica.com/3.1/openclinica-user-guide')">
